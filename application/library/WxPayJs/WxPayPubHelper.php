...
define('APPID', 'wxf3b8281f2a822121');
// 受理商ID，身份标识
define('MCHID', '1385189102');
// 商户支付密钥Key。审核通过后，在微信发送的邮件中查看
define('KEY', 'e6a035c3f6dce3e7bc7b99cdd120c05e');
// JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
define('APPSECRET', 'a8de747eeb0c0554bb518a7f5cb5b21d');
// 证书路径,注意应该填写绝对路径
define('SSLCERT_PATH', __DIR__ . DIRECTORY_SEPARATOR . 'cacert' . DIRECTORY_SEPARATOR . 'apiclient_cert.pem');
define('SSLKEY_PATH', __DIR__ . DIRECTORY_SEPARATOR . 'cacert' . DIRECTORY_SEPARATOR . 'apiclient_key.pem');
// 异步通知url，商户根据实际开发过程设定
define('NOTIFY_URL', APPLICATION_URL . '/wxpayjs_proxy.php');
