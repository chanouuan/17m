...
class Checkcode {
    ...
    {
        // 设置字体
        $this->font = __DIR__ . DIRECTORY_SEPARATOR . 'font' . DIRECTORY_SEPARATOR . 'elephant.ttf';
    }

    /**
     * 生成随机验证码。
     */
    protected function creat_code ($definedCode = '')
    {
        if (!$definedCode)
        {
            $code = '';
     ...
     * 生成图片
     */
    public function doimage ($definedCode = '')
    {
        $code = $this->creat_code($definedCode);
